...
#ifndef YBER_QABSTRACTKINETICSCROLLER_H
#define YBER_QABSTRACTKINETICSCROLLER_H

#include <QtCore/qmetatype.h>
#include <QtCore/qpoint.h>
#include <QtCore/qrect.h>

#define YBERHACK_QT_BEGIN_NAMESPACE
#define YBERHACK_QT_END_NAMESPACE
#define YBERHACK_QT_BEGIN_HEADER
#define YBERHACK_QT_MODULE(a)
#define YBERHACK_Q_DECLARE_METATYPE(a) Q_DECLARE_METATYPE(YberHack_Qt::a)

YBERHACK_QT_BEGIN_HEADER

YBERHACK_QT_BEGIN_NAMESPACE

YBERHACK_QT_MODULE(Gui)

class QMouseEvent;
class QGraphicsSceneMouseEvent;

namespace YberHack_Qt {
...
public:
    ...
    unsigned scrollsPerSecond() const;
    void setScrollsPerSecond(unsigned);
...
YBERHACK_QT_END_NAMESPACE

YBERHACK_Q_DECLARE_METATYPE(QAbstractKineticScroller *)
